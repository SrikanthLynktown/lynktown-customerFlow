    ...
    return (
        <>
            <div className="relative flex md:py-10 lg:min-h-screen flex-col justify-center overflow-hidden md:bg-[#6A5B40]">
                <div className="relative bg-white px-6 pt-20 pb-16 shadow-xl mx-auto w-full max-w-lg rounded-2xl">
                    <div className="mx-auto flex w-full max-w-md flex-col">
                        <div className='mx-auto flex justify-center '>
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="w-[51px] h-[64px] lg:w-[76px] lg:h-[96px]">
