        ...
        <>
            <div className="flex justify-center md:bg-[#6A5B40] lg:min-h-screen md:py-6  ">
                <div className="">
                    <div >
                        <div
                            className="flex flex-wrap items-center justify-center w-[375px] lg:w-[706px] grayscale  md:grayscale-0 opacity-" >
                            <div className="">
                                <div
                                        ...
                                        <div className=" md:w-[326px] lg:w-[326px]">
                                            <div className="p- rounded">
                                                <Image src="images/img1.svg" alt=""
                                                    ...
                                                    // style={{ background: "linearGradient(180deg, rgba(10, 10, 10, 0) 17.8%, rgba(10, 10, 10, 0.9) 73.28%)" }}
                                                />
                                            </div>
                                            ...
                                            <div className="px-12  md:p-4 -mt-80 md:-mt-0">
                                                ...
                                                <div className="flex mt-20 gap-2 mx-auto justify-center w-[280px]">
                                                    ...
                                                    <div class="w-[132px]  bg-gray rounded-full h-1 mt-4">
                                                        <div class="bg-[#000000] h-1  text-red-300 rounded-full w-[44px]" ></div>
                                                    </div>
