            ...
            <div className=''>
                    ...
                    <div className="flex w-full flex-wrap items-center justify-between">
                        <div
                            ...
                            <Image
                                ...
                                height={12}
                            />
                            <div className='text-[#0A0A0A] text-[18px] leading-[28px] font-normal font-serif '>Orders</div>
                        </div>
                ...
                <div className='invisible md:visible'>
                    ...
                    <div className='px-10 py- md:py-10 flex gap-6 '>
                        ...
                        />
                        <span className='text-[#6A5B40] text-[42px] leading-[22px] font-normal font-serif '>Orders</span>
                    </div>
                </div>
                ...
                <div className=''>
                    ...
                    <p className='text-center underline text-[#0A0A0A] text-[20px] leading-[28px] font-normal font-sans '>
                        <a href="">
                        Explore Lynks to place an order
                        </a>
                    </p>
                </div>
            </div>
